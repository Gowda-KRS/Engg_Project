...
public class HideProcessMsgnew
{
	...
	public static boolean hideProcess(BufferedImage image, String msg,String outFilePath) 
	{
		boolean flag = false;
		//String key_binary[]=HideProcess.getBinary(key);
		String msg_binary[]=HideProcessMsgnew.getBinary(msg);
		int[][] imageMatrix=HideProcessMsgnew.imageMatrix(image,msg.length());
		...
		if(imageMatrix!=null)
		{
			HideProcessMsgnew.hideProcess(image,imageMatrix,msg_binary,outFilePath);
	...
	private static boolean hideProcess(BufferedImage image,int[][] imageMatrix,String msg_binary[],String outFilePath)
	{
...
//            		System.out.println();
	...
	private static int[][] imageMatrix(BufferedImage image, int length)
	{
		return null;
...
//        	System.out.println();
	...
	private static int getOnes(int[][] Imat, int width, int height) 
	{
		int count=0;
		for (int i = 0; i < width; i++)
		{
	...
	private static String[] getBinary(String str) 
	{
...
//		System.out.println("--->"+str);
	...
	public static String extractProcess1(BufferedImage image,int length)
	{
		String data = "";
		//String key_binary[]=HideProcessMsgnew.getBinary(key);
		int[][] imageMatrix1=HideProcessMsgnew.imageMatrix(image,length);
		String msg1[]=HideProcessMsgnew.extractProcess(image,imageMatrix1);
