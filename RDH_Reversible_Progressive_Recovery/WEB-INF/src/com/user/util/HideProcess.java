...
{
	public static boolean hideProcess(BufferedImage image,String key,String dataToHide,String outFilePath)
	{
		boolean flag = false;
		String key_binary[]=HideProcess.getBinary(key);
		String msg_binary[]=HideProcess.getBinary(dataToHide);
		int[][] imageMatrix=HideProcess.imageMatrix(image,key_binary,dataToHide.length());
