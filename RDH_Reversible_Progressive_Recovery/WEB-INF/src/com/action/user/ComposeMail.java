...
import com.user.util.CL_SendMail;
...
public class ComposeMail extends HttpServlet
{
	...
	private static  String fromEmailId="send.user.details@gmail.com";
	private static  String password="blrstore@123";
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
	{
		...
		boolean flag = false;
		String s = "",fileName = "",ext="",filepath = "",inFilePath = "",outFilePath = "",username="";
		...
		try 
		{
			...
			if(flag)
			{
				...
				if(flag)
				{
					...
					rd = getServletContext().getRequestDispatcher("/res/jsp/user/cancel.jsp?no=1");
					rd.forward(request, response);
				}
				else
				{
					System.out.println("Opps,Something Went Wrong While Sending The Mail!!!!");
					rd=request.getRequestDispatcher("/res/jsp/user/compose_mail.jsp?no1=1");
					rd.forward(request, response);
				}
